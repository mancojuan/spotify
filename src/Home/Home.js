                ...
                <div className="container my-5">
                    <div className="row">
                        <div className="col-12 col-md-8">
                            ...
                            <img src="http://www.colombiainforma.info/wp-content/uploads/2018/06/28685860_2303855849630802_7509663444856688181_n.jpg" className="img-fluid w-100"></img>
                        </div>
                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4 text-center">
                           <img src="https://www.elespectador.com/resizer/08lnOh0paTI0-FukNyFMDgilOVk=/1200x675/filters:format(jpeg)/cloudfront-us-east-1.images.arcpublishing.com/elespectador/PYAIU7PC7JHOJFPR7NCAZ5KMH4.jpg" alt="" className="img-fluid w-80"/>
                        ...
                        <div className="col-12 col-md-4  text-center">
                           <img src="https://revistadiners.com.co/wp-content/uploads/2019/02/alcolirykoz_800x669.jpg" alt="" className="img-fluid w-80"/>
                        ...
                        <div className="col-12 col-md-4  text-center">
                           <img src="https://www.elespectador.com/resizer/QuptaTWqCO3PYgu61lEmxt2t_CA=/525x350/filters:format(jpeg)/cloudfront-us-east-1.images.arcpublishing.com/elespectador/5RCNFEY7XJCWZK5IXWCLI6WGUA.jpg" alt="" className="img-fluid w-80"/>
